...
interface Props {
  selected: "active" | "underperforming" | "none" | null;
  onSelect: (val: "active" | "underperforming" | "none") => void;
}

const OPTIONS = [
  { id: "active" as const, icon: PlayCircle, title: "Ja, aktivt", description: "Vi kører allerede kampagner der performer." },
  { id: "underperforming" as const, icon: AlertTriangle, title: "Ja, men de performer ikke", description: "Vi har annoncer kørende, men resultaterne er ikke tilfredsstillende." },
  { id: "none" as const, icon: Radio, title: "Nej, vi starter fra bunden", description: "Vi har ikke kørt annoncer før." },
];

const PaidAdsStep1 = ({ selected, onSelect }: Props) => (
  <div className="w-full max-w-2xl mx-auto">
    <div className="text-center mb-8">
      <h2 className="text-2xl sm:text-3xl font-bold text-hero-foreground mb-2">Kører I allerede annoncer?</h2>
      <p className="text-hero-muted">Fortæl os om jeres nuværende annoncering.</p>
    </div>
