...
const OPTIONS = [
  { id: "full", label: "Fuld tracking opsat", description: "Pixel, conversion API og events er sat korrekt op." },
  { id: "partial", label: "Delvist", description: "Noget tracking er opsat, men ikke fuldt ud." },
  { id: "none", label: "Nej", description: "Der er ingen tracking opsat." },
  { id: "unsure", label: "Ved ikke", description: "Vi er ikke sikre på status." },
];

const PaidAdsStep6 = ({ selected, onSelect }: Props) => (
  <div className="w-full max-w-2xl mx-auto">
    <div className="text-center mb-8">
      <h2 className="text-2xl sm:text-3xl font-bold text-hero-foreground mb-2">Tracking</h2>
      <p className="text-hero-muted">Har I tracking opsat på jeres website?</p>
    </div>
