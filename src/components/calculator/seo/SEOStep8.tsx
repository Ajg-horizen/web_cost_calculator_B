...
const OPTIONS = [
  { id: "self", label: "Vi skriver selv", description: "Vi producerer alt indhold internt." },
  { id: "blog-help", label: "Hjælp til blogindhold", description: "Vi har brug for hjælp til at skrive blogindlæg." },
  { id: "seo-texts", label: "SEO-tekster til sider", description: "Vi har brug for optimerede tekster til vores sider." },
  { id: "full-strategy", label: "Fuld content-strategi", description: "Vi har brug for en komplet indholdsplan og produktion." },
];

const SEOStep8 = ({ selected, onSelect }: Props) => (
  <div className="w-full max-w-2xl mx-auto">
    <div className="text-center mb-8">
      <h2 className="text-2xl sm:text-3xl font-bold text-hero-foreground mb-2">Indholdsproduktion</h2>
      <p className="text-hero-muted">Hvordan håndterer I indhold i dag?</p>
    </div>
