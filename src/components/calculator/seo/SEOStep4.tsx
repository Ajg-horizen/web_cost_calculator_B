...
const OPTIONS = [
  { id: "low", label: "Lav konkurrence", description: "Nichemarked med få konkurrenter." },
  { id: "medium", label: "Mellem konkurrence", description: "Moderat antal konkurrenter i branchen." },
  { id: "high", label: "Høj konkurrence", description: "Mange aktive konkurrenter om de samme søgeord." },
  { id: "unknown", label: "Ved ikke", description: "Vi er usikre på konkurrenceniveauet." },
];

const SEOStep4 = ({ selected, onSelect }: Props) => (
  <div className="w-full max-w-2xl mx-auto">
    <div className="text-center mb-8">
      <h2 className="text-2xl sm:text-3xl font-bold text-hero-foreground mb-2">Branche & konkurrence</h2>
      <p className="text-hero-muted">Hvor hård er konkurrencen i jeres branche?</p>
    </div>
