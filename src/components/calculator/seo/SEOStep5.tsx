...
const OPTIONS = [
  { id: "yes", label: "Ja", description: "Vi har lavet en grundig søgeordsanalyse." },
  { id: "partial", label: "Delvist", description: "Vi har kigget på det, men ikke en fuld analyse." },
  { id: "no", label: "Nej", description: "Vi har ikke lavet søgeordsanalyse." },
];

const SEOStep5 = ({ selected, onSelect }: Props) => (
  <div className="w-full max-w-2xl mx-auto">
    <div className="text-center mb-8">
      <h2 className="text-2xl sm:text-3xl font-bold text-hero-foreground mb-2">Har I lavet søgeordsanalyse?</h2>
      <p className="text-hero-muted">En søgeordsanalyse er fundamentet for effektiv SEO.</p>
    </div>
